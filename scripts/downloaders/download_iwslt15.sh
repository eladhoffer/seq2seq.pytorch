...
echo "Download vocab file train.en.word.vocab and train.vi.word.vocab."
curl -o "$OUT_DIR/vocab.en" "$SITE_PREFIX/iwslt15.en-vi/vocab.en"
curl -o "$OUT_DIR/vocab.vi" "$SITE_PREFIX/iwslt15.en-vi/vocab.vi"

tail -n 17188 "$OUT_DIR/vocab.en" > "$OUT_DIR/train.en.word.vocab"
tail -n 7706 "$OUT_DIR/vocab.vi" > "$OUT_DIR/train.vi.word.vocab"
